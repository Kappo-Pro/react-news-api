...
function Gnews() {
    ...
    const [categoryList] = useState(["general", "world", "nation", "business", "technology", "entertainment", "sports", "science", "health"]);
    ...
    const getNews = async () => {
        await axios.get("https://gnews.io/api/v4/top-headlines?category=" + category + "&country=" + country + "&q=" + searchBar + "&apikey=3ae540c8e40b65de660fb2081291dcbe")
            .then((response) => {
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-transparent fixed-top" style={{ margin: '10px 7vw 30px 7vw' }}>
                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <div className="form-inline my-2 my-lg-0" style={{ display: 'flex', marginLeft: '45vw' }}>
                        ...
                        <button className="btn btn-primary my-2 my-sm-0" type="submit" onClick={() => {
                            setPage(1);
                            getNews();
                        }}>Search</button>
                    </div>
